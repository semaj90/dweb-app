...
const (
	...
	Embedder_BatchEmbed_FullMethodName = "/embed.Embedder/BatchEmbed"
)
...
func (c *embedderClient) Embed(ctx context.Context, in *EmbedRequest, opts ...grpc.CallOption) (*EmbedResponse, error) {
	...
	err := c.cc.Invoke(ctx, Embedder_Embed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *embedderClient) BatchEmbed(ctx context.Context, in *BatchEmbedRequest, opts ...grpc.CallOption) (*BatchEmbedResponse, error) {
	out := new(BatchEmbedResponse)
	err := c.cc.Invoke(ctx, Embedder_BatchEmbed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEmbedderServer) BatchEmbed(context.Context, *BatchEmbedRequest) (*BatchEmbedResponse, error) {
...
func _Embedder_BatchEmbed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchEmbedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmbedderServer).BatchEmbed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Embedder_BatchEmbed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmbedderServer).BatchEmbed(ctx, req.(*BatchEmbedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Embedder_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Embedder_BatchEmbed_Handler,
		},
	},
