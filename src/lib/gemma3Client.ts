...
export class Gemma3Client {
  ...
  async askLegalQuestion(question: string, context?: string): Promise<string> {
    const messages: ChatMessage[] = [
      {
        role: "system",
        content: `You are a specialized Legal AI Assistant with expertise in contract analysis, legal document review, case law research, and legal compliance. You provide accurate, professional legal information and analysis. Always maintain professional accuracy and cite relevant legal principles when applicable.${
  ...
  async reviewContract(
    ...
    const messages: ChatMessage[] = [
      {
        role: "system",
        content: `You are a specialized Legal AI Assistant for contract review. Analyze the contract for key terms, potential risks, missing clauses, compliance issues, and provide recommendations for improvement.${
