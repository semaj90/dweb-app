...
func (g *EnhancedMultiProtocolGateway) loadEnhancedDefaultServices() {
	...
	protocols := []ProtocolType{ProtocolQUIC, ProtocolgRPC, ProtocolHTTP, ProtocolWebSocket}
...
// Environment helpers moved to envutil.go to eliminate duplication

// All environment utility functions (getEnv, getEnvInt, getEnvBool, getEnvFloat, getEnvDuration) 
// are now centralized in envutil.go to eliminate code duplication
