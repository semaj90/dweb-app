...
const importGuide = {
  ...
  legacy: {
    "import aiCommands from './stores/ai-commands'": "✅ Works - Redirects to ai-unified.ts",
    "import { evidence } from './stores/evidence'": "✅ Works - Redirects to evidence-unified.ts", 
    "import { parseAICommand } from './stores/ai-command-parser'": "✅ Works - Available in ai-unified.ts"
  },
  
  // Recommended new imports
  modern: {
    "import { aiStore, parseAICommand } from './stores/ai-unified'": "✅ Recommended",
    "import { evidenceStore, evidenceById } from './stores/evidence-unified'": "✅ Recommended",
