...
<script lang="ts">
  ...
  // Reactive data
  // Svelte 5: use reactive statements instead of invalid $derived syntax
  ...
  // initialize fuse whenever tab or data changes
...
<div
  ...
  <!-- Sidebar content -->
  {#if sidebarOpen}
    <div class="space-y-4" transition:slide={{ duration: 300, easing: quintOut }}>
      <!-- Header -->
      <div class="space-y-4">
