...
<div class="case-scoring-card bg-slate-900 border border-slate-700 rounded-lg p-4">
    ...
    <div class="flex items-center gap-4 mb-6">
      <div class="relative">
        ...
        <div class="absolute -bottom-1 -right-1">
          <Badge variant="secondary" class="{getScoreColor(scoring.score)} text-white text-xs px-2 py-1">
      ...
      <div class="flex-1">
        ...
        <Progress.Root value={scoring.score} max={100} class="w-full h-2 bg-slate-800">
          <Progress.Indicator 
    ...
    <div class="grid grid-cols-2 gap-3 mb-4">
      <div class="score-metric">
        <div class="flex justify-between items-center mb-1">
          ...
          <span class="text-sm font-medium text-white">{scoring.breakdown.admissibility}</span>
        </div>
        <Progress.Root value={scoring.breakdown.admissibility} max={25} class="w-full h-1 bg-slate-800">
          <Progress.Indicator class="bg-blue-500 h-full rounded" style="width: {(scoring.breakdown.admissibility/25)*100}%" />
        </Progress.Root>
      </div>
      ...
      <div class="score-metric">
        <div class="flex justify-between items-center mb-1">
          ...
          <span class="text-sm font-medium text-white">{scoring.breakdown.relevance}</span>
        </div>
        <Progress.Root value={scoring.breakdown.relevance} max={25} class="w-full h-1 bg-slate-800">
          <Progress.Indicator class="bg-green-500 h-full rounded" style="width: {(scoring.breakdown.relevance/25)*100}%" />
        </Progress.Root>
      </div>
      ...
      <div class="score-metric">
        <div class="flex justify-between items-center mb-1">
          ...
          <span class="text-sm font-medium text-white">{scoring.breakdown.quality}</span>
        </div>
        <Progress.Root value={scoring.breakdown.quality} max={25} class="w-full h-1 bg-slate-800">
          <Progress.Indicator class="bg-yellow-500 h-full rounded" style="width: {(scoring.breakdown.quality/25)*100}%" />
        </Progress.Root>
      </div>
      ...
      <div class="score-metric">
        <div class="flex justify-between items-center mb-1">
          ...
          <span class="text-sm font-medium text-white">{scoring.breakdown.strategic}</span>
        </div>
        <Progress.Root value={scoring.breakdown.strategic} max={25} class="w-full h-1 bg-slate-800">
          <Progress.Indicator class="bg-purple-500 h-full rounded" style="width: {(scoring.breakdown.strategic/25)*100}%" />
        </Progress.Root>
      </div>
    </div>
