...
`;
  ...
  private getEnhancedMetrics(): EnhancedPerformanceMetrics {
...
// TODO: Export all types for external consumption
export type {
  EnhancedOptimizationSuite,
  OptimizationProfile,
