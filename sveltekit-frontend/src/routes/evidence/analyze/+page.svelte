<script lang="ts">
	...
	import { SelectRoot, SelectContent, SelectItem, SelectTrigger, SelectValue } from '$lib/components/ui/select';
	...
	<Card class="w-full">
		...
		<CardFooter class="flex justify-between">
			...
			<div class="flex gap-2">
				...
				<Button onclick={startAnalysis} disabled={analyzing || !caseId || !evidenceContent}>
			...
			<CardContent class="space-y-6">
				...
				<div class="space-y-4">
					{#each steps as step, i}
						...
						<Card class="transition-all duration-300 {isActive ? 'ring-2 ring-primary shadow-md' : ''}">
								...
								<div class="flex items-center gap-4">
									...
									<div class="flex-shrink-0">
										...
										{:else if isProcessing}
											<div class="w-10 h-10 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center animate-pulse">
												{step.icon}
											</div>
										{:else}
									...
									<div class="flex-grow">
										<div class="flex items-center gap-2">
											<h3 class="font-semibold {isActive ? 'text-primary' : ''}">{step.name}</h3>
											{#if isProcessing}
										...
										<p class="text-xs text-muted-foreground">Est. {step.duration}</p>
									</div>
