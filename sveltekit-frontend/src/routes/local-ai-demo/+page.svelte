            ...
            <div class="space-y-4">
              {#each systemStatus.localModels as model}
                <div class="space-y-4">
                  ...
                  {#if !model.isLoaded}
                    <button
                      on:onclick={() => loadLocalModel(model.id)}
                      class="space-y-4"
                    >
                      Load Model
                    </button>
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-4">
                <button
                  class="space-y-4"
                  on:onclick={() => (selectedProvider = "auto")}
                >
                  <Brain class="space-y-4" />
                  Auto
                </button>
                <button
                  class="space-y-4"
                  on:onclick={() => (selectedProvider = "local")}
                ...
                <button
                  class="space-y-4"
                  on:onclick={() => (selectedProvider = "cloud")}
                >
                  <Cloud class="space-y-4" />
                  Cloud Only
                </button>
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-4">
            ...
            <button
              on:onclick={() => analyzeLegalDocument()}
