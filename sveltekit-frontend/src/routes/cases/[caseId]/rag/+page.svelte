  ...
  {/if}
    ...
    <div class="mb-4">
      ...
      <div class="mt-3 flex flex-wrap gap-2">
        ...
        <button
          on:onclick={() => startAIAnalysis('summary')}
          disabled={$loading}
        ...
        <button
          on:onclick={() => startAIAnalysis('recommendation')}
          disabled={$loading}
          class="px-3 py-1 text-sm bg-gray-100 text-gray-700 rounded hover:bg-gray-200 disabled:opacity-50"
        >
          Recommend Actions
        ...
        <button
          on:onclick={() => startAIAnalysis('similarity')}
          disabled={$loading}
          class="px-3 py-1 text-sm bg-gray-100 text-gray-700 rounded hover:bg-gray-200 disabled:opacity-50"
        >
          Find Precedents
