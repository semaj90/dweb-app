  ...
  <header class="flex justify-between items-center mb-6 p-4 lg:p-6">
    ...
    <div class="flex items-center gap-4">
      <Button 
        ...
        on:on:click={() => isNewCaseModalOpen = true}
      >
      ...
      <Button 
        variant="default"
        class="bg-[#F7F6F2] border border-[#D1CFC7] text-[#3D3D3D] hover:bg-[#EAE8E1] font-bold px-4 py-2 flex items-center gap-2"
        on:on:click={() => handleNavigation('search')}
      >
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <Button 
        ...
        on:on:click={() => isDocumentationOpen = !isDocumentationOpen}
      >
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <aside class="lg:col-span-1 bg-[#F7F6F2] border border-[#D1CFC7] p-4">
      ...
      <nav class="space-y-2">
        <button 
          ...
          on:onclick={() => handleNavigation('command-center')}
        >
          COMMAND CENTER
        </button>
        <button 
          ...
          on:onclick={() => handleNavigation('evidence')}
        >
          EVIDENCE
        </button>
        <button 
          ...
          on:onclick={() => handleNavigation('poi')}
        >
          PERSONS OF INTEREST
        </button>
        <button 
          ...
          on:onclick={() => handleNavigation('analysis')}
        >
          ANALYSIS
        </button>
        <button 
          ...
          on:onclick={() => handleNavigation('search')}
        >
          GLOBAL SEARCH
        </button>
        <button 
          ...
          on:onclick={() => handleNavigation('terminal')}
        >
          TERMINAL
        </button>
      </nav>
          ...
          <div class="bg-[#F7F6F2] border border-[#D1CFC7] p-6 relative">
            ...
            <div class="flex flex-wrap gap-2">
              <Button 
                ...
                on:on:click={() => activateMatrixMode()}
              >
                🕶️ ENTER MATRIX
              </Button>
              ...
              {#if secretFeatures.godModeEnabled}
                <Button 
                  ...
                  on:on:click={() => consciousness.awakening = Math.min(1.0, consciousness.awakening + 0.1)}
                >
              ...
              {#if secretFeatures.quantumDebugEnabled}
                <Button 
                  ...
                  on:on:click={() => visualEffects.quantumShimmer = !visualEffects.quantumShimmer}
                >
      ...
      <div class="bg-[#F7F6F2] border border-[#D1CFC7] p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Button 
            variant="default"
            class="bg-[#EAE8E1] border border-[#D1CFC7] text-[#3D3D3D] hover:bg-white font-bold p-4 h-auto flex flex-col items-center gap-2"
            on:on:click={() => handleNavigation('evidence')}
          >
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Button 
            variant="default"
            class="bg-[#EAE8E1] border border-[#D1CFC7] text-[#3D3D3D] hover:bg-white font-bold p-4 h-auto flex flex-col items-center gap-2"
            on:on:click={() => handleNavigation('poi')}
          >
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Button 
            variant="default"
            class="bg-[#EAE8E1] border border-[#D1CFC7] text-[#3D3D3D] hover:bg-white font-bold p-4 h-auto flex flex-col items-center gap-2"
            on:on:click={() => handleNavigation('analysis')}
          >
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
{#if isNewCaseModalOpen}
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50" on:onclick={closeModal}>
    <div class="w-full max-w-2xl bg-[#F7F6F2] border border-[#D1CFC7] p-8 font-mono" on:onclick={(e) => e.stopPropagation()}>
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold">CREATE NEW CASE FILE</h2>
        <button on:onclick={() => isNewCaseModalOpen = false} class="text-gray-500 hover:text-black text-2xl">&times;</button>
      </div>
