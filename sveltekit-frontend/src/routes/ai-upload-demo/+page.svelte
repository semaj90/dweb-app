	...
	<div class="container mx-auto p-8">
		<div class="max-w-6xl mx-auto">
			...
			<div class="bg-white rounded-lg shadow-lg p-6 mb-8">
				...
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
					<button 
						on:onclick={() => testAPI('/api/ocr/langextract')}
					...
					<button 
						on:onclick={() => testAPI('/api/embeddings/generate')}
					...
					<button 
						on:onclick={() => testAPI('/api/documents/search')}
					...
					<button 
						on:onclick={() => testAPI('/api/embeddings/generate', 'POST', { text: 'Test legal document about contracts', model: 'nomic-embed-text' })}
