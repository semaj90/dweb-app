<script lang="ts">
  ...
  import { 
    ...
    tableManager,
    statusFormatters 
  } from '$lib/components/yorha/index.js';
...
<svelte:head>
  <title>YoRHa Tables Demo - Legal AI System</title>
</svelte:head>

<div class="yorha-demo-container">
  <div class="yorha-demo-header">
    <h1 class="yorha-demo-title">YoRHa TABLE/GRID SYSTEM</h1>
    <div class="yorha-demo-subtitle">Legal AI Data Management Interface</div>
  ...
  {#if selectedDemo === 'table'}
    <div class="yorha-demo-section">
      <h2 class="yorha-section-title">LEGAL CASES TABLE</h2>
      <div class="yorha-section-description">
        Basic YoRHa table with pagination, sorting, and selection capabilities
      </div>
    ...
    <div class="yorha-demo-section">
      <h2 class="yorha-section-title">COMPACT EVIDENCE TABLE</h2>
      <div class="yorha-section-description">
        Dense table layout for evidence management
      </div>
  ...
  {:else}
    <div class="yorha-demo-section">
      ...
      <div class="yorha-section-description">
        Advanced data grid with filtering, editing, and virtual scrolling
      </div>
  ...
  <div class="yorha-demo-stats">
    ...
    <div class="yorha-stats-grid">
      <div class="yorha-stat-item">
        ...
        <div class="yorha-stat-label">CASES</div>
      </div>
      <div class="yorha-stat-item">
        <div class="yorha-stat-value">{sampleEvidence.length}</div>
        <div class="yorha-stat-label">EVIDENCE</div>
      </div>
      <div class="yorha-stat-item">
  ...
  <div class="yorha-demo-features">
    <h3 class="yorha-features-title">COMPONENT FEATURES</h3>
    <div class="yorha-features-grid">
      <div class="yorha-feature">
        <div class="yorha-feature-icon">⚡</div>
        <div class="yorha-feature-title">REACTIVE SORTING</div>
        <div class="yorha-feature-desc">Click column headers to sort data</div>
      </div>
      <div class="yorha-feature">
        <div class="yorha-feature-icon">🔍</div>
        <div class="yorha-feature-title">ADVANCED FILTERING</div>
        <div class="yorha-feature-desc">Column-specific and global search</div>
      </div>
      <div class="yorha-feature">
        <div class="yorha-feature-icon">✏️</div>
        <div class="yorha-feature-title">INLINE EDITING</div>
        <div class="yorha-feature-desc">Edit cells directly in the grid</div>
      </div>
      <div class="yorha-feature">
        <div class="yorha-feature-icon">📊</div>
        <div class="yorha-feature-title">VIRTUAL SCROLLING</div>
        <div class="yorha-feature-desc">Handle thousands of rows efficiently</div>
      </div>
      <div class="yorha-feature">
        <div class="yorha-feature-icon">🎯</div>
        <div class="yorha-feature-title">ROW SELECTION</div>
        <div class="yorha-feature-desc">Single and multi-row selection</div>
      </div>
      <div class="yorha-feature">
        <div class="yorha-feature-icon">⚙️</div>
        <div class="yorha-feature-title">CUSTOMIZABLE</div>
        <div class="yorha-feature-desc">Themes, layouts, and behaviors</div>
      </div>
    </div>
  </div>
</div>
