<script lang="ts">
  ...
  function showInfoNotification() {
    notifications.info('Information', 'Here is some useful information about the current process.');
  }
...
<div class="space-y-4">
  <div class="space-y-4">
    <!-- Header -->
    <div class="space-y-4">
      <h1 class="space-y-4">UI Components Demo</h1>
      <p class="space-y-4">
        Explore our comprehensive UI component library built with Svelte stores, UnoCSS, PicoCSS,
        Melt UI, and Bits UI. All components feature interactive updates, modern styling, and
    ...
    <div class="space-y-4">
      ...
      <Card variant="elevated" padding="lg">
        {#snippet header()}
          <div>
            <h2 class="space-y-4">Button Variants</h2>
            <p class="space-y-4">Different button styles and states with loading support</p>
          </div>
        {/snippet}
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-4">
            ...
            <Button variant="secondary" class="space-y-4">
              <iconify-icon data-icon="${1}" class="space-y-4"></iconify-icon>
              Download Report
            </Button>
          </div>
      ...
      <Card variant="elevated" padding="lg">
        {#snippet header()}
          <div>
            <h2 class="space-y-4">Notification System</h2>
            <p class="space-y-4">Toast notifications with actions and auto-dismiss</p>
          </div>
        {/snippet}
      ...
      <Card variant="elevated" padding="lg">
        {#snippet header()}
          <div>
            <h2 class="space-y-4">Modal System</h2>
            <p class="space-y-4">Confirm dialogs, alerts, and prompts</p>
          </div>
        {/snippet}
      ...
      <Card variant="elevated" padding="lg">
        {#snippet header()}
          <div>
            <h2 class="space-y-4">Interactive Cards</h2>
            <p class="space-y-4">Cards with hover effects and selection states</p>
          </div>
        {/snippet}
        ...
        <div class="space-y-4">
          <Card
            ...
            <div class="space-y-4">
              <div>
                <h3 class="space-y-4">Clickable Card</h3>
                <p class="space-y-4">Click to select/deselect</p>
              </div>
              <div class="space-y-4">
          ...
          <Card variant="filled" padding="md">
            {#snippet header()}
              <div>
                <h3 class="space-y-4">Card with Slots</h3>
              </div>
            {/snippet}

            <p class="space-y-4">This card demonstrates the header and footer slots.</p>
          ...
          <Card variant="elevated" loading padding="md">
            <p class="space-y-4">This card is in a loading state...</p>
          </Card>
        </div>
      </Card>
      ...
      <div class="space-y-4">
        <Card variant="elevated" padding="lg">
          {#snippet header()}
            <div>
              <h2 class="space-y-4">Advanced Form System</h2>
              <p class="space-y-4">Forms with validation, error handling, and real-time feedback</p>
            </div>
          {/snippet}
          ...
          <Form
            ...
            class="space-y-4">
            <div>
              {#snippet children({ form, formApi, values, errors, isValid, isDirty })}
                <div class="space-y-4">
                  <h3 class="space-y-4">Account Information</h3>
                </div>
                ...
                <div class="space-y-4">
                  <label class="space-y-4">
                    <input
                      ...
                      onchange={(e) =>
                        formApi.setField('terms', (e.target as HTMLInputElement)?.checked)}
    ...
    <Card variant="outlined" padding="lg" class="space-y-4">
      {#snippet header()}
        <div>
          <h2 class="space-y-4">🚀 Component Features</h2>
        </div>
      {/snippet}
