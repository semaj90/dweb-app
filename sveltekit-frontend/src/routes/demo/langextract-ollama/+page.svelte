...
<div class="container mx-auto p-6 space-y-8">
  ...
  <div class="bg-white rounded-lg shadow-sm border p-6">
    ...
    <div class="mb-4">
      ...
      <div class="flex flex-wrap gap-2">
        <button on:onclick={() => loadSampleText('contract')} class="px-3 py-1 text-sm bg-blue-100 text-blue-700 rounded hover:bg-blue-200">Contract</button>
        <button on:onclick={() => loadSampleText('case_law')} class="px-3 py-1 text-sm bg-green-100 text-green-700 rounded hover:bg-green-200">Case Law</button>
        <button on:onclick={() => loadSampleText('statute')} class="px-3 py-1 text-sm bg-purple-100 text-purple-700 rounded hover:bg-purple-200">Statute</button>
        <button on:onclick={() => loadSampleText('evidence')} class="px-3 py-1 text-sm bg-orange-100 text-orange-700 rounded hover:bg-orange-200">Evidence</button>
      </div>
    </div>
