...
async function validateSchema() {
  ...
  try {
    ...
    const expectedTables = [
      ...
      'notes', 'ai_history', 'collaboration_sessions'
    ];
    ...
    const unexpectedTables = actualTableNames.filter(name => 
...
async function testRelations(client) {
  try {
    ...
    console.log(`✓ Relations working (sample query returned ${sampleQuery.length} rows)`);
