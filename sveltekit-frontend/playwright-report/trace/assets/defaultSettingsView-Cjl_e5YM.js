  ...
  for (let u = 0; u < o.length; u++) {
    ...
    if (d.name === "internal:control" && d.body === "enter-frame") {
      const k = l[l.length - 1],
        _ = o[u - 1],
        E = k.map((N) =>
          t.chainLocators([N, t.generateLocator(p, "frame", "")]),
        );
  ...
  Xu = (t, e) => {
    ...
    const {
      ...
      v =
        t.class === "Test" &&
        t.method === "step" &&
        ((N = t.annotations) == null
          ? void 0
          : N.some((A) => A.type === "skip"));
    let S = "";
    t.endTime
...
function lE(t, e) {
  ...
  if (ke(e)) {
    ...
    ((s = e), (n = t.find((l) => l.nodeClass && s instanceof l.nodeClass)));
  if (!n) {
    const l =
    ...
    F = R.useCallback(
      (G) => {
        ...
        const K = G.clientX - y.current.getBoundingClientRect().left,
          $ = un(g.width, e, K),
          X =
            t == null ? void 0 : t.actions.findLast((ge) => ge.startTime <= $);
        if (!G.buttons) {
          S(void 0);
          return;
        }
    ...
    z = R.useCallback(() => {
      if ((_(void 0), !!v)) {
        if (v.startX !== v.endX) {
          ...
          const G = un(g.width, e, v.startX),
            K =
              t == null ? void 0 : t.actions.findLast(($) => $.startTime <= G);
          (K && s(K), d(void 0));
        }
        S(void 0);
      }
    ...
    q = R.useCallback(
      (G) => {
        ...
        const K = G.clientX - y.current.getBoundingClientRect().left,
          $ = un(g.width, e, K),
          X =
            t == null ? void 0 : t.actions.findLast((ce) => ce.startTime <= $);
