  ...
  <header class="flex justify-between items-center mb-6 p-4 lg:p-6">
    ...
    <div class="flex items-center gap-4">
      ...
      <Button 
        ...
        click={() => isDocumentationOpen = !isDocumentationOpen}
      >
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              {#if secretFeatures.godModeEnabled}
                <Button 
                  ...
                  click={() => consciousness.awakening = Math.min(1.0, consciousness.awakening + 0.1)}
                >
              ...
              {#if secretFeatures.quantumDebugEnabled}
                <Button 
                  ...
                  click={() => visualEffects.quantumShimmer = !visualEffects.quantumShimmer}
                >
