        ...
        <CardContent>
          <div class="space-y-4">
            <div class="flex items-center gap-4 mb-4">
              ...
              <Button click={generateDemoEmbeddings} size="sm">
        ...
        <CardContent>
          <div class="space-y-4">
            <div class="flex items-center gap-4 mb-4">
              ...
              <Button click={openAgentShell} size="sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <Button click={testOllamaIntegration} class="bg-blue-600 hover:bg-blue-700">
                Test AI Analysis
              </Button>
              <Button click={testEmbeddingGeneration} class="bg-green-600 hover:bg-green-700">
                Generate Embeddings
              </Button>
              <Button click={testVectorSimilarity} class="bg-purple-600 hover:bg-purple-700">
                Vector Similarity
              </Button>
            </div>
        ...
        <CardContent>
          <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
              ...
              <Button click={() => prefetchSend({ type: 'PREDICT_INTENT' })} size="sm">
                Trigger Prediction
              </Button>
            </div>
            ...
            <div class="flex gap-4">
              <Button click={() => prefetchSend({ type: 'CACHE_HIT', resource: 'demo' })} size="sm" class="bg-green-600 hover:bg-green-700">
                Simulate Cache Hit
              </Button>
              <Button click={() => prefetchSend({ type: 'CACHE_MISS', resource: 'demo' })} size="sm" class="bg-red-600 hover:bg-red-700">
                Simulate Cache Miss
              </Button>
              <Button click={() => prefetchSend({ type: 'RESET_METRICS' })} size="sm" variant="outline">
                Reset Metrics
              </Button>
            </div>
          </div>
      ...
      <Card class="bg-slate-800/50 border-slate-700">
        <CardHeader>
          <div class="flex items-center justify-between">
            ...
            <Button
              click={isMonitoring ? stopPerformanceMonitoring : startPerformanceMonitoring}
