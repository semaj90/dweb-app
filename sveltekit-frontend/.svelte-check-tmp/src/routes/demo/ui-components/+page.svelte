  ...
  <div class="min-h-[500px] border rounded-lg p-6 bg-card">
    ...
    {:else if selectedDemo === 'accordion'}
      <div class="space-y-6">
        ...
        <div data-melt-stripped class="space-y-2">
