        ...
        <CardContent class="space-y-4">
          ...
          <div class="flex flex-wrap gap-2">
            <Button 
              ...
              click={() => addNotification('success', 'Bits UI Button clicked! 🎮')}
            >
              Hybrid Button
            </Button>
            ...
            <Button 
              variant="outline" 
              class="nes-btn"
              click={() => addNotification('warning', 'Warning: Retro mode activated!')}
            >
              Outline + NES
            </Button>
          </div>
...
{#if $open}
  ...
  >
    <div class="nes-container with-title is-rounded bg-nier-bg-primary">
      ...
      <h2 data-melt-stripped class="title text-nier-accent-warm">🎮 System Dialog</h2>
