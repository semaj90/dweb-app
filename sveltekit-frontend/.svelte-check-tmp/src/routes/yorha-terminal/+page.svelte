...
<div class="yorha-terminal-page">
		...
		<div class="header-right">
			<div class="role-switcher">
				<Button
					...
					click={() => switchRole("detective")}
				>
					Detective
				</Button>
				<Button
					class="role-btn {currentRole.value === 'prosecutor' ? 'active' : ''}"
					click={() => switchRole("prosecutor")}
				>
					Prosecutor
				</Button>
				<Button
	...
	<div class="quick-commands">
		<Button click={() => { terminalInput.value = "help"; executeCommand(); }}>Help</Button>
		<Button click={() => { terminalInput.value = "status"; executeCommand(); }}>Status</Button>
		<Button click={() => { terminalInput.value = "context7"; executeCommand(); }}>Test Context7</Button>
		<Button click={() => { terminalInput.value = "analyze contract dispute"; executeCommand(); }}>Sample Analysis</Button>
		<Button click={() => { terminalInput.value = "clear"; executeCommand(); }}>Clear</Button>
	</div>
</div>
