    ...
    <CardContent class="space-y-4">
      ...
      <div class="flex gap-2">
        <Input
          ...
          class="flex-1" />
        <button click={performSearch} disabled={isSearching || !searchQuery.trim()} class="inline-flex items-center justify-center gap-2 rounded-md bg-primary text-primary-foreground py-2 px-3 hover:opacity-90 transition disabled:opacity-50">
          {#if isSearching}
            Loading...
          {:else}
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div class="flex gap-2">
                <Button size="sm">
              <div class="flex gap-2">
                <button click={() => handleAISummarizeResult(law)} class="inline-flex items-center gap-2 rounded-md bg-primary text-primary-foreground px-3 py-1 text-sm">
                  <Bot class="h-4 w-4 mr-2" />
                  <span>AI Summary</span>
                </button>
                <button click={() => handleAIChatResult(law)} class="inline-flex items-center gap-2 rounded-md border px-3 py-1 text-sm">
