<script lang="ts">
  ...
  import EvidenceUploader from '$lib/components/evidence/EvidenceUploader.svelte';
  import {
    evidenceActions,
    evidenceGrid,
    uploadActions,
...
<div class="container-nes-main">
  ...
  <!-- Enhanced RAG Ingestion: lightweight panel -->
  <div class="mb-6">
    <EvidenceUploader />
  </div>
  ...
  <div class="mx-auto px-4 max-w-7xl">
    ...
    {#if showFilters}
      ...
      >
        <div>
          <label for="type-filter" class="mx-auto px-4 max-w-7xl">Evidence Type</label
          >
          <select
            id="type-filter"
            class="mx-auto px-4 max-w-7xl"
        ...
        <div>
          <label for="status-filter" class="mx-auto px-4 max-w-7xl">Status</label>
          <select
            id="status-filter"
            class="mx-auto px-4 max-w-7xl"
        ...
        <div>
          <label for="collector-filter" class="mx-auto px-4 max-w-7xl"
            >Collected By</label
          >
          <input
            id="collector-filter"
        ...
        <div>
          <label for="date-from" class="mx-auto px-4 max-w-7xl">Date From</label>
          <input
            id="date-from"
            type="date"
            class="mx-auto px-4 max-w-7xl"
        ...
        <div>
          <label for="date-to" class="mx-auto px-4 max-w-7xl">Date To</label>
          <input
            id="date-to"
            type="date"
            class="mx-auto px-4 max-w-7xl"
  ...
  {:else if error}
    <div class="mx-auto px-4 max-w-7xl" role="alert">
      ...
      <Button variant="outline" size="sm" click={() => refreshEvidence()}>
  ...
  {:else if filteredEvidence.length === 0}
    <div class="mx-auto px-4 max-w-7xl">
      ...
      {#if !searchQuery && !selectedType && !selectedStatus && !selectedCollector && !dateFrom && !dateTo}
        <div class="mx-auto px-4 max-w-7xl">
          <Button click={() => openUploadModal()} class="mx-auto px-4 max-w-7xl">
            ...
            >
              ...
              <div class="flex gap-2 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                <Button
                  ...
                  click={() => analyzeEvidence(evidence)}
...
<EvidenceValidationModal
  ...
  complete={handleValidationComplete}
/>
  ...
  <div class="mx-auto px-4 max-w-7xl">
    <div class="mx-auto px-4 max-w-7xl">
      <div class="mx-auto px-4 max-w-7xl">
        ...
        <Button variant="ghost" size="sm" click={closeAnalysisModal}>
          ✕
        </Button>
      </div>
      ...
      <div class="mx-auto px-4 max-w-7xl">
        <Button variant="outline" click={closeAnalysisModal}>Close</Button>
        <Button click={() => {
  ...
  <div class="mx-auto px-4 max-w-7xl">
    <div class="mx-auto px-4 max-w-7xl">
      ...
      <AdvancedFileUpload
        ...
        cancel={() => (showAdvancedUpload = false)}
      />
    </div>
    <div
      class="mx-auto px-4 max-w-7xl"
      ...
      keydown={(e) => e.key === "Escape" && (showAdvancedUpload = false)}
    ></div>
  </div>
{/if}
