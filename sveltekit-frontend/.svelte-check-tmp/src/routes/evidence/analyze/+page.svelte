  ...
  <Card class="w-full">
    ...
    <CardFooter class="flex justify-between">
      ...
      <div class="flex gap-2">
        <Button variant="outline" click={resetForm} disabled={analyzing}>Reset</Button>
        <Button click={startAnalysis} disabled={analyzing || !caseId || !evidenceContent}>
  ...
  {#if showResults && results}
    <Dialog bind:open={showResults}>
      <DialogContent class="max-w-4xl max-h-[80vh] overflow-y-auto">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Button
                  ...
                  size="sm"
                  class="mt-2"
                  click={() => viewDetailedResults(data)}>
                  View Details →
                </Button>
              </CardContent>
            </Card>
        ...
        <DialogFooter>
          <Button variant="outline" click={() => (showResults = false)}>Close</Button>
          <Button click={() => goto(`/cases/${caseId}`)}>View Case Details</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  {/if}
