...
<div class="container mx-auto p-6 space-y-6">
  ...
  <Card>
    ...
    <CardContent>
      <div class="text-center py-8 space-y-4">
        ...
        <div class="space-y-2">
          <Button click={() => window.open('/api/v1/ingest', '_blank')}>
            Test API Directly
          </Button>
        </div>
      </div>
  ...
  <div class="text-center text-sm text-muted-foreground space-y-2">
    ...
    <div class="flex justify-center space-x-4">
      <Button variant="outline" size="sm" click={checkServiceHealth}>
        🔄 Refresh Status
      </Button>
      <Button variant="outline" size="sm" click={loadRecentIngests}>
        📊 Load Recent
      </Button>
    </div>
  </div>
