        ...
        <div class="h-full flex flex-col">
          <div class="p-4 border-b border-slate-200 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-1">
              <Button size="sm" variant="ghost" click={() => adjustPanelWidth('reports', -5)}>
                <Minimize class="h-3 w-3" />
              </Button>
              <Button size="sm" variant="ghost" click={() => togglePanel('reports')}>
                <Minimize class="h-3 w-3" />
              </Button>
            </div>
          </div>
      ...
      {#if !panelLayout.summaries.collapsed}
        <div class="h-full flex flex-col">
          <div class="p-4 border-b border-slate-200 flex items-center justify-between">
            ...
            <Button size="sm" variant="ghost" click={() => togglePanel('summaries')}>
              <Minimize class="h-3 w-3" />
            </Button>
          </div>
      ...
      {#if !panelLayout.citations.collapsed}
        <div class="h-full flex flex-col">
          <div class="p-4 border-b border-slate-200 flex items-center justify-between">
            ...
            <Button size="sm" variant="ghost" click={() => togglePanel('citations')}>
              <Minimize class="h-3 w-3" />
            </Button>
          </div>
    ...
    <div
      ...
      {#if !panelLayout.chat.collapsed}
        ...
        <div class="p-4 border-b border-slate-200 flex items-center justify-between">
          ...
          <Button size="sm" variant="ghost" click={() => togglePanel('chat')}>
        ...
        <div class="p-4 border-t border-slate-200">
          ...
          <div class="flex space-x-2">
            ...
            <Button click={sendMessage} disabled={!currentMessage.trim() || isProcessing}>
              <Send class="h-4 w-4" />
            </Button>
          </div>
        </div>
