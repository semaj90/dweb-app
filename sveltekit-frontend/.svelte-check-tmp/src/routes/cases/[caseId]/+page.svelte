<script lang="ts">
  ...
  let workflowStage: LegalCaseContext['workflowStage'] | undefined;
  let nextActions: string[] = [];
  let canStartAIAnalysis: boolean = false;
  let stats: { totalEvidence: number; processedEvidence: number; averageConfidence: number; processingTime: number } = { totalEvidence: 0, processedEvidence: 0, averageConfidence: 0, processingTime: 0 };
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 flex-1">
              ...
              <div class="mt-4 flex space-x-3">
                ...
                <Button size="sm" variant="ghost" click={handleDismissError}>
                  Dismiss
                </Button>
              </div>
            </div>
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-sm transition-shadow">
                          <div class="flex items-start justify-between">
                            ...
                            <div class="ml-4 flex-shrink-0 flex space-x-2">
                              ...
                              <Button size="sm" click={() => send({ type: 'SELECT_EVIDENCE', evidence: item })}>
                                Select
                              </Button>
                            </div>
                          </div>
