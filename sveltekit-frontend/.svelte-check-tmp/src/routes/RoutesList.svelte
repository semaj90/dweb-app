<script lang="ts">
  ...
  <script lang="ts">
  // Auto-discover routes using Vite's import.meta.glob and keep everything in one script
  // so TypeScript/Svelte scope/context issues are avoided.
  // If your build complains about import.meta.glob typings, uncomment the ts-ignore line below.
  ...
  // Use the auto-discovered routes by default, fallback to a static list if needed
  export let routes: Route[] = autoRoutes.length ? autoRoutes : [
    { path: "/", label: "Home" },
    { path: "/ai", label: "AI" },
    { path: "/ai-assistant", label: "AI Assistant" },
    // ...rest of your static fallback
  ];
</script>
...
<div class="routes-list">
  ...
  <ul>
    {#each routes as route}
      <li><a href={route.path} sveltekit:prefetch>{route.label}</a></li>
    {/each}
  </ul>
</div>

<!-- filepath: c:\Users\james\Desktop\deeds-web\deeds-web-app\sveltekit-frontend\src\lib\components\ui\gaming\n64\N64TextureFilteringCache.svelte -->
<!--
...
<style>
  ...
  let {
    ...
    { path: "/bits-uno-demo", label: "Bits Uno Demo" },
    { path: "/cases", label: "Cases" },
    { path: "/crud-dashboard", label: "CRUD Dashboard" },
    { path: "/dashboard", label: "Dashboard" },
    { path: "/demo", label: "Demo" },
    { path: "/detective", label: "Detective" },
    { path: "/document-editor-demo", label: "Document Editor Demo" },
    { path: "/documents", label: "Documents" },
    { path: "/editor", label: "Editor" },
    { path: "/enhanced-ai-demo", label: "Enhanced AI Demo" },
    { path: "/evidence", label: "Evidence" },
    { path: "/evidence-editor", label: "Evidence Editor" },
    { path: "/export", label: "Export" },
    { path: "/frameworks-demo", label: "Frameworks Demo" },
    { path: "/help", label: "Help" },
    { path: "/import", label: "Import" },
    { path: "/interactive-canvas", label: "Interactive Canvas" },
    { path: "/law", label: "Law" },
    { path: "/legal", label: "Legal" },
    { path: "/local-ai-demo", label: "Local AI Demo" },
    { path: "/login", label: "Login" },
    { path: "/logout", label: "Logout" },
    { path: "/modern-demo", label: "Modern Demo" },
    { path: "/nier-showcase", label: "Nier Showcase" },
    { path: "/original-home", label: "Original Home" },
    { path: "/profile", label: "Profile" },
    { path: "/rag-demo", label: "RAG Demo" },
    { path: "/register", label: "Register" },
    { path: "/report-builder", label: "Report Builder" },
    { path: "/reports", label: "Reports" },
    { path: "/saved-citations", label: "Saved Citations" },
    { path: "/search", label: "Search" },
    { path: "/security", label: "Security" },
    { path: "/settings", label: "Settings" },
    { path: "/test-ai-ask", label: "Test AI Ask" },
