    ...
    <Card class="p-6 bg-slate-800/30 border-slate-600">
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-2">
          <Button
            click={() => startVisualization('attentionHeatmap')}
          ...
          <Button
            click={() => startVisualization('documentNetwork')}
            disabled={!isInitialized}
          ...
          <Button
            click={() => startVisualization('evidenceTimeline')}
            disabled={!isInitialized}
          ...
          <Button
            click={() => startVisualization('textFlow')}
            disabled={!isInitialized}
        ...
        <div class="flex gap-2">
          {#if isRendering}
            <Button click={stopVisualization} class="bg-red-600 hover:bg-red-700">
              Stop Rendering
            </Button>
          {/if}

          <Button
            click={executeGPUWorkload}
            disabled={!isInitialized}
            variant="outline"
