    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
      ...
      <Card class="p-6 bg-slate-800/30 border-slate-600">
        ...
        <div class="space-y-4">
          ...
          <div class="flex gap-2">
            <Button
              click={() => scaleCluster(targetWorkers)}
            ...
            <Button
              click={() => scaleCluster(clusterHealth.totalWorkers + 1)}
              disabled={isScaling}
              variant="outline"
              class="px-3">
              +1
            ...
            <Button
              click={() => scaleCluster(Math.max(1, clusterHealth.totalWorkers - 1))}
      ...
      <Card class="p-6 bg-slate-800/30 border-slate-600">
        ...
        <div class="space-y-3">
          ...
          <Button click={fetchClusterStatus} variant="outline" class="w-full">
            <RefreshCw class="h-4 w-4 mr-2" />
            Refresh Status
          </Button>
        </div>
