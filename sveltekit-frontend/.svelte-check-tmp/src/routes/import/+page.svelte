        ...
        <div class="space-y-4">
          <div class="space-y-4">
            ...
            <Tooltip content="Clear current import and start over">
              <Button variant="outline" click={() => clearImport()}>
                <X class="space-y-4" />
                Cancel
              </Button>
            </Tooltip>
            ...
            <div class="space-y-4">
              <Tooltip content="Download JSON example for cases">
                <Button
                  variant="outline"
                  size="sm"
                  click={() => downloadExampleTemplate("cases", "json")}
                >
                  JSON
                </Button>
              </Tooltip>
              <Tooltip content="Download CSV example for cases">
                <Button
                  variant="outline"
                  size="sm"
                  click={() => downloadExampleTemplate("cases", "csv")}
                >
                  CSV
                </Button>
              </Tooltip>
            ...
            <div class="space-y-4">
              <Tooltip content="Download JSON example for evidence">
                <Button
                  variant="outline"
                  size="sm"
                  click={() => downloadExampleTemplate("evidence", "json")}
                >
                  JSON
                </Button>
              </Tooltip>
              <Tooltip content="Download CSV example for evidence">
                <Button
                  variant="outline"
                  size="sm"
                  click={() => downloadExampleTemplate("evidence", "csv")}
                >
                  CSV
                </Button>
              </Tooltip>
