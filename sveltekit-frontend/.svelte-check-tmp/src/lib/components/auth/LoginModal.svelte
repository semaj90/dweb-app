...
<button data-melt-stripped style="display: none;">Open Modal</button>

{#if $openStore}
  <div data-melt-stripped class="container mx-auto px-4"></div>
  <div data-melt-stripped class="container mx-auto px-4">
    <h2 data-melt-stripped class="container mx-auto px-4">Login</h2>
    <button data-melt-stripped class="container mx-auto px-4">X</button>
