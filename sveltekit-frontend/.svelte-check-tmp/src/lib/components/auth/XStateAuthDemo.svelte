      ...
      {#if demoStep === 'dashboard' && authenticated}
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Button click={demonstrateAI} variant="outline">
              <Brain class="h-4 w-4 mr-2" />
              Test AI Assistant
            </Button>

            <Button click={demonstrateUpload} variant="outline">
              <Zap class="h-4 w-4 mr-2" />
              Demo File Upload
            </Button>

            <Button click={demonstrateSessionActivity} variant="outline">
              <Settings class="h-4 w-4 mr-2" />
              Record Activity
            </Button>
          </div>

          <Button click={demonstrateLogout} variant="destructive" class="w-full">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-2">
              <Button click={() => demoStep = 'dashboard'} variant="outline">
                Back to Dashboard
              </Button>
              <Button click={demonstrateLogout} variant="destructive">
                <LogOut class="h-4 w-4 mr-2" />
                Complete Demo
              </Button>
            </div>
