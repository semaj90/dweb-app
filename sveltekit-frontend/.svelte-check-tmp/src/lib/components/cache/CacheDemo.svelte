        ...
        <Card>
          ...
          <CardContent class="space-y-4">
            ...
            <div class="flex flex-wrap gap-2">
              <Button click={setCacheValue} disabled={$isLoading}>
                <Database class="mr-2" size={16} />
                Set Value
              </Button>
              
              <Button variant="outline" click={getCacheValue} disabled={$isLoading}>
                <RefreshCw class="mr-2" size={16} />
                Get Value
              </Button>
              
              <Button variant="destructive" click={deleteCacheValue} disabled={$isLoading}>
                <Trash2 class="mr-2" size={16} />
                Delete
              </Button>
              
              <Button variant="destructive" click={clearCache} disabled={$isLoading}>
