...
{#each $toasts as toast (toast.id)}
  <div data-melt-stripped class="toast yorha-toast">
    <div data-melt-stripped>{toast.data.title}</div>
    <div data-melt-stripped>{toast.data.description}</div>
    <button data-melt-stripped class="toast-close">&times;</button>
  </div>
{/each}
