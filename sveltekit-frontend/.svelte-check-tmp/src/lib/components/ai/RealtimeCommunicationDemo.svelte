  ...
  <Card>
    <CardHeader>
      <CardTitle class="flex items-center justify-between">
        ...
        {#if !isInitialized}
          <Button click={initializeConnection} disabled={isInitializing} class="px-4 py-2">
            {isInitializing ? 'Initializing...' : 'Connect'}
          </Button>
        {:else}
          <Button click={disconnect} class="px-4 py-2 bg-red-600 hover:bg-red-700">
            Disconnect
          </Button>
        {/if}
      </CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          <div class="space-y-4">
            ...
            <Button click={sendTestMessage} class="w-full">Send Message</Button>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div class="space-y-4">
            ...
            <Button click={startStreamingRequest} class="w-full">Start Stream</Button>
          </div>
        </CardContent>
      </Card>
    </div>
    ...
    <Card>
      <CardHeader>
        <CardTitle class="flex items-center justify-between">
          ...
          <Button click={testPerformance} class="text-sm px-3 py-1">Run Performance Test</Button>
        </CardTitle>
      </CardHeader>
      <CardContent>
