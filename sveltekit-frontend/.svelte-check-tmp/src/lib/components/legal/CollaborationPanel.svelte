      ...
      <CardHeader>
        <CardTitle class="flex items-center justify-between text-sm">
          ...
          <Button
            variant="outline"
            size="sm"
            click={() => showAnnotationInput = !showAnnotationInput}
          >
            Add Note
          </Button>
        </CardTitle>
      ...
      <CardContent class="space-y-3">
        {#if showAnnotationInput}
          <div class="border border-gray-200 rounded-lg p-3 bg-gray-50">
            ...
            />
            <div class="flex space-x-2">
              <Button click={addAnnotation} size="sm" disabled={!newAnnotation.trim()}>
                Add Annotation
              </Button>
              <Button click={() => showAnnotationInput = false} variant="outline" size="sm">
                Cancel
              </Button>
            </div>
          </div>
