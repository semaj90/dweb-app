...
<div class="evidence-manager space-y-6">
  ...
  <div class="flex justify-between items-center">
    ...
    {#if allowUpload}
      <Button click={() => (showUpload = true)} class="gap-2">
  ...
  {#if !loading && filteredEvidence.length === 0}
    <div class="text-center py-12">
      {#if evidence.length === 0}
        ...
        {#if allowUpload}
          <Button click={() => (showUpload = true)} variant="outline" class="gap-2">
            <Upload class="w-4 h-4" />
    ...
    >
      ...
      <div class="space-y-6">
        ...
        <div class="flex gap-3 pt-4">
          ...
          <Button
            click={() => { if (!uploadLoading) { resetUploadForm(); showUpload = false; } }}
            variant="outline"
            class="flex-1"
