...
<div class="mx-auto px-4 max-w-7xl">
  ...
  <!-- Bits UI Button -->
  <Button.Root class="mx-auto px-4 max-w-7xl" click={showSuccessNotification}>
    Create New Case
  </Button.Root>
    ...
    <AlertDialog.Portal>
      ...
      <AlertDialog.Content class="mx-auto px-4 max-w-7xl">
        ...
        <div class="mx-auto px-4 max-w-7xl">
          ...
          <AlertDialog.Action class="mx-auto px-4 max-w-7xl" click={showErrorNotification}>
            Delete Permanently
          </AlertDialog.Action>
        </div>
      </AlertDialog.Content>
    ...
    >
      <div class="mx-auto px-4 max-w-7xl">
        {#if (data as ToastData).title}
          <div class="mx-auto px-4 max-w-7xl" data-melt-stripped>
            {(data as ToastData).title}
          </div>
        {/if}
        <button class="mx-auto px-4 max-w-7xl" data-melt-stripped aria-label="Close notification">
          ✕
        </button>
      </div>
