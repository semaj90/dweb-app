  ...
  <Card class="mb-4">
    ...
    <CardContent>
      <div class="flex flex-wrap gap-2">
        ...
        <!-- Add Annotation -->
        {#if !readOnly}
          <Button variant="outline" click={addAnnotation}>
        ...
        <!-- Zoom Controls -->
        <Button variant="outline" click={zoomIn}>
          <ZoomIn class="h-4 w-4" />
        </Button>
        <Button variant="outline" click={zoomOut}>
          <ZoomOut class="h-4 w-4" />
        </Button>
        <Button variant="outline" click={resetZoom}>
        ...
        <!-- Save & Export -->
        {#if !readOnly}
          <Button variant="default" click={saveCanvas}>
            <Save class="h-4 w-4 mr-2" />
            Save
          </Button>
        {/if}
        
        <Button variant="outline" click={exportCanvas}>
