...
<form method="POST" use:enhance class="space-y-4">
  ...
  <div>
    ...
    <div data-melt-stripped class="space-y-4">
      ...
      <div data-melt-stripped)}>Image</div>
      <div data-melt-stripped)}>Video</div>
      <div data-melt-stripped)}>Audio</div>
      <div data-melt-stripped)}>Other</div>
    </div>
  ...
  <div class="space-y-4">
    <Button type="button" variant="ghost" click={() => dispatch("cancel")}
      >Cancel</Button
    >
