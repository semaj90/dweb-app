    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="space-y-6">
        ...
        <Card>
          ...
          <CardContent class="space-y-3">
            <Button variant="outline" click={() => checkSystemHealth()} class="w-full">
              Health Check
            </Button>
            <Button variant="outline" click={() => syncCache()} class="w-full">
              Sync Cache
            </Button>
            <Button variant="outline" click={() => clearErrors()} class="w-full">
              Clear Errors
            </Button>
            <Button variant="destructive" click={() => clearCache()} class="w-full">
              Clear Cache
            </Button>
          </CardContent>
        </Card>
