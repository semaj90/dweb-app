...
></div>
            ...
            >
              <h2 data-melt-stripped class="text-2xl font-display nier-heading mb-4">
                System Alert
              </h2>
              <p data-melt-stripped class="text-nier-gray dark:text-nier-silver mb-6">
                This is a NieR: Automata styled modal dialog using Melt UI.
              </p>
              
              <div class="flex gap-4 justify-end">
                <button data-melt-stripped class="nier-button-outline px-4 py-2">
                  Cancel
                </button>
