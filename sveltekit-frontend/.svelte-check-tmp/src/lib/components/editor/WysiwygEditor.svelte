...
<div data-melt-stripped>
  {#if $aiOpen}
    ...
    <div data-melt-stripped class="space-y-4">
      <h2 data-melt-stripped class="space-y-4">AI Legal Assistant</h2>
      ...
      <button data-melt-stripped class="space-y-4">×</button>
    </div>
  {/if}
</div>
...
<div data-melt-stripped>
  {#if $citeOpen}
    <div data-melt-stripped class="space-y-4"></div>
    <div data-melt-stripped class="space-y-4">
      <h2 data-melt-stripped class="space-y-4">Citation Helper</h2>
