        ...
        <CardContent class="space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="space-y-2">
              ...
              <div class="space-y-2">
                <Button click={demoLogin} disabled={authenticatedUser !== null}>
                  Demo Login
                </Button>
                <Button click={demoAIInteraction} disabled={!authenticatedUser}>
                  Test AI Assistant
                </Button>
                <Button click={demoLogout} disabled={!authenticatedUser} variant="outline">
                  Demo Logout
                </Button>
              </div>
            </div>
        ...
        <CardContent>
          {#if !authenticatedUser}
            <div class="space-y-4">
              ...
              <Button click={() => showAuthDialog = true}>
          ...
          {:else}
            <div class="space-y-4">
              ...
              <Button click={demoLogout} variant="outline">
                Logout
              </Button>
            </div>
          {/if}
          ...
          {#if activeSession}
            <div class="space-y-4">
              ...
              <div class="flex gap-2">
                <Button 
                  click={() => sessionManager.performSecurityCheck()} 
                  size="sm"
                >
                  Security Check
                </Button>
                <Button 
                  click={() => sessionManager.refreshSession()} 
                  size="sm" 
                  variant="outline"
                >
                  Refresh Session
