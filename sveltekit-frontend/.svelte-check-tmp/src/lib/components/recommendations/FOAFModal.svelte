...
{#if open}
  <div data-melt-stripped class="fixed inset-0 z-50 bg-black/50" transitifade={{ duration: 150 }}>
    <div
      data-melt-stripped
    ...
    >
      ...
      <div class="flex items-center justify-between mb-4">
        <h2 data-melt-stripped class="text-xl font-semibold text-gray-900 flex items-center gap-2">
          <Users class="w-5 h-5" />
