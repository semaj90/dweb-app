    ...
    <div class="space-y-4">
      <div class="space-y-4">
        ...
        <div class="space-y-4">
          ...
          <button class="space-y-4" click={() => createNew("cases")}>
            <Plus size={16} />
          </button>
        </div>
      </div>
      ...
      <div class="space-y-4">
        <button class="space-y-4" click={() => viewAll("cases")}>
          View All Cases
        </button>
      </div>
    </div>
    ...
    <div class="space-y-4">
      <div class="space-y-4">
        ...
        <div class="space-y-4">
          ...
          <button class="space-y-4" click={() => createNew("evidence")}>
            <Plus size={16} />
          </button>
        </div>
      </div>
      ...
      <div class="space-y-4">
        <button class="space-y-4" click={() => viewAll("evidence")}>
          View All Evidence
        </button>
      </div>
    </div>
    ...
    <div class="space-y-4">
      <div class="space-y-4">
        ...
        <div class="space-y-4">
          ...
          <button class="space-y-4" click={() => createNew("reports")}>
            <Plus size={16} />
          </button>
        </div>
      </div>
      ...
      <div class="space-y-4">
        <button class="space-y-4" click={() => viewAll("reports")}>
          View All Reports
        </button>
      </div>
    </div>
    ...
    <div class="space-y-4">
      <div class="space-y-4">
        ...
        <div class="space-y-4">
          ...
          <button class="space-y-4" click={() => createNew("activities")}>
            <Plus size={16} />
          </button>
        </div>
      </div>
      ...
      <div class="space-y-4">
        <button class="space-y-4" click={() => viewAll("activities")}>
          View All Activities
        </button>
      </div>
    </div>
