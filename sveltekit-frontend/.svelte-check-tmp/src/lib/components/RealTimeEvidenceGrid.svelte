  ...
  {:else if paginatedEvidence.length === 0}
    ...
    <div class="mx-auto px-4 max-w-7xl">
      <div class="mx-auto px-4 max-w-7xl">
        ...
        <Button click={() => createEvidence()}>Add First Evidence</Button>
      </div>
    </div>
  {:else}
    <!-- Evidence Grid/List -->
