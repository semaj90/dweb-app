    ...
    {:else if currentTab === 'dialogs'}
      ...
      <div class="demo-config-section">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <Button variant="yorha" legal click={() => dialogOpen = true}>
            Case Management
          </Button>
          
          <Button variant="primary" legal click={() => evidenceDialogOpen = true}>
            Evidence Upload
          </Button>
          
          <Button variant="outline" legal click={runAIAnalysis} loading={aiAnalysisLoading}>
        ...
        >
          {#snippet content()}
              ...
              <div class="bits-dialog-footer">
                <Button variant="outline" click={() => evidenceDialogOpen = false}>
                  Cancel
                </Button>
                <Button variant="primary" legal click={uploadEvidence} disabled={evidenceUploadProgress > 0}>
                  Upload Evidence
                </Button>
              </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {#each mockEvidenceItems as item (item.id)}
            <Card
              ...
              click={() => selectEvidenceCard(item.id)}
            >
              <div class="space-y-3">
