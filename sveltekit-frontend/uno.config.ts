...
export default defineConfig({
  ...
  theme: {
    colors: {
      ...
      "yorha-primary": "#3a372f",
      "yorha-secondary": "#75726a",
      "yorha-background": "#f4f1ea",
      "yorha-surface": "#faf8f3",
      "yorha-text": "#3a372f",
      "yorha-border": "#ada895",
      "yorha-accent": "#d5cfb7",
  ...
  shortcuts: {
    ...
    "yorha-panel-header":
      "border-b border-nier-border-secondary p-4 bg-nier-bg-tertiary",
    ...
    "agent-card":
      "yorha-card p-4 space-y-3 hover:scale-[1.02] transition-transform duration-200",
    "agent-autogen":
      "border-l-4 border-l-agent-autogen bg-gradient-to-r from-purple-50 to-transparent",
    "agent-crewai":
      "border-l-4 border-l-agent-crewai bg-gradient-to-r from-cyan-50 to-transparent",
    "agent-autonomous":
    ...
    "copilot-response-area":
      "yorha-panel-content max-h-96 overflow-y-auto yorha-scrollbar",
    "copilot-status-bar":
      "flex items-center justify-between p-2 bg-nier-bg-tertiary border-t border-nier-border-secondary text-sm",

    // Processing States
    "processing-overlay":
      "absolute inset-0 bg-nier-overlay z-10 flex items-center justify-center",
    ...
    "recommendation-architecture":
      "recommendation-card border-l-4 border-l-blue-500",
    "recommendation-performance":
      "recommendation-card border-l-4 border-l-green-500",
    "recommendation-security":
      "recommendation-card border-l-4 border-l-red-500",
    "recommendation-testing":
      "recommendation-card border-l-4 border-l-purple-500",
    "recommendation-deployment":
      "recommendation-card border-l-4 border-l-orange-500",
    ...
    "bits-btn-default":
      "bits-btn bg-primary text-primary-foreground hover:bg-primary/90",
    ...
    "bits-btn-secondary":
      "bits-btn bg-secondary text-secondary-foreground hover:bg-secondary/80",
    ...
    "vector-metadata-grid":
      "grid grid-cols-2 md:grid-cols-4 gap-3 text-sm text-muted-foreground",
    "vector-highlight":
      "bg-yellow-200 dark:bg-yellow-800/30 px-1 py-0.5 rounded text-foreground",
    ...
    "relationship-item":
      "flex items-center gap-2 p-2 bg-muted/50 rounded-lg text-sm",
    "relationship-from": "font-medium text-foreground",
    "relationship-type":
      "text-xs text-muted-foreground px-2 py-1 bg-background rounded",
