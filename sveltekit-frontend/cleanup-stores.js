...
const storesDir = 'C:/Users/james/Desktop/deeds-web/deeds-web-app/sveltekit-frontend/src/lib/stores';
...
const summary = {
  ...
  activeStores: fs.readdirSync(storesDir)
    .filter(f => f.endsWith('.ts') || f.endsWith('.js'))
    .filter(f => !f.includes('backup') && !f.includes('unified'))
    .length,
