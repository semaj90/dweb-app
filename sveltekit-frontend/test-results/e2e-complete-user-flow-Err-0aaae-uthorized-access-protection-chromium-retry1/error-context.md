...
- generic [ref=e3]:
  ...
  - main [ref=e12]:
    - generic [ref=e15]:
      ...
      - paragraph [ref=e18]: "src/routes/dashboard/+page.svelte:14:2 Cannot use `export let` in runes mode — use `$props()` instead https://svelte.dev/e/legacy_export_invalid"
      - group [ref=e19]
