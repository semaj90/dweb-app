...
function registerCommands(context) {
    ...
    context.subscriptions.push(analyzeContextCommand, suggestBestPracticesCommand, getContextAwareDocsCommand, analyzeErrorsCommand, analyzeStackCommand, startServerCommand, stopServerCommand);
}
